using System;
	...
	class MainClass
	{
		public static void Main (string[] args)
		{
			...
			Console.WriteLine ("Digite o quatro numeros inteiros");
      ...
      Console.WriteLine ("A soma dos pares = " + resultado_par);
      Console.WriteLine ("A soma dos impares = " + resultado_impar);
		}
	}